...
class MainWindow(QMainWindow):
    ...
    def _init_ui(self):
        ...
        # 页5: 选股
        self._init_page_stock_selector()
    ...
    def _init_page_stock_selector(self):
        """初始化选股页"""
        self.stock_selector_panel = StockSelectorPanel()
        self.stock_selector_panel.stockClicked.connect(self._on_stock_clicked)
        self.stack.addWidget(self.stock_selector_panel)
